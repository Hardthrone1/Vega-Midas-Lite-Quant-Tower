/**
 * Vega-memory-policy.js
 * --------------------------------------------------------------------------
 * Memory-conditioned prompt policy for the Vega swarm.
 *
...
class PromptPolicy {
  ...
  static buildMemoryBriefing(agentName, tags, indexer) {
    ...
    return `\n\n[Vega MEMORY CONDITIONING]\n${lines.join('\n')}\n[END CONDITIONING]\n`;
  }
}

module.exports = { VegaMemoryIndex, PromptPolicy, MIN_AGENT_SAMPLES, VIABLE_PF };
